...
![example frontend](https://i.imgur.com/vsAgrb7.png)
Started with the source code for the [Web Playback SDK Guide](https://developer.spotify.com/documentation/web-playback-sdk/guide/).
